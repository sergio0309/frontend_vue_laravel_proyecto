            ...
            <div class="max-w-4xl flex items-center h-auto flex-wrap mx-auto my-32 lg:my-0">
                ...
                <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                    <div class="p-4 md:p-12 text-center lg:text-left">
                        ...
                        style="background-image: url('https://images.pexels.com/photos/104827/cat-pet-animal-domestic-104827.jpeg')"></div>
                ...
                <div class="w-full lg:w-2/5">
                    ...
                    <img src="https://images.pexels.com/photos/104827/cat-pet-animal-domestic-104827.jpeg" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
